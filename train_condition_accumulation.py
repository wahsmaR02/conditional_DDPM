...
# since batch_size = 2 --> effective batch size of 2 * 4 = 8
accum_steps = 4  # number of mini-batches to accumulate before one optimizer setp
...
for epoch in range(1, num_epochs + 1):
    ...
    for batch_idx, batch in enumerate(train_loader):
        ...
        loss = loss / numel         # per-voxel loss
        ...
        # step every 'accum_steps' batchs, or at the bery end
