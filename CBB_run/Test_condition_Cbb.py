...
from Diffusion_condition_Cbb import GaussianDiffusionSampler_cond
...
output_dir = "./test_results_3d_Cbb"
os.makedirs(output_dir, exist_ok=True)

#patch_size = (64, 128, 128)
#stride = (58, 115, 115)  # overlap sliding window
patch_size = (32, 96, 96)
stride = (16, 48, 48) # <----- 50% overlap
T = 1000
ch = 64
ch_mult = [1, 2, 3, 4]
attn = [] #[2]
       ...
       # Process patches in batches
        for batch_start in tqdm(range(0, len(patches), batch_size)):
            ...
            for z, y, x in batch_coords:
                ...
                noise = noise_full[:, :, z:z+pD, y:y+pH, x:x+pW]
            ...
            batch_noise = torch.stack(batch_noises, dim=0).squeeze(1)
...
def main():
    ...
    for p in test_dataset.patients:
        ...
        sitk.WriteImage(out_img, os.path.join(output_dir, f"{pid}_sct_Cbb.mha"))
