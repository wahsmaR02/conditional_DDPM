...
def pad_or_crop_to(arr, h=SLICE_SIZE, w=SLICE_SIZE, constant_values = -1):
    """
    ...
    if ph > 0 or pw > 0:
        cropped = np.pad(cropped, ((top, bottom), (left, right)), mode="constant", constant_values=constant_values)
