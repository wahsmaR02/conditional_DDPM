...
from functions.image_metrics import ImageMetrics  # MAE, PSNR, MS-SSIM
...
dataset_root = "/content/drive/MyDrive/Project_in_Scientific_Computing/playground"   # !! Change to root folder containing patient subfolders
